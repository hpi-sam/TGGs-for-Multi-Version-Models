...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>java2class Child Pkg adapted child Pkg adapted</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.mdelab.migmm.java2class_adapted.generated.impl.java2classChildPkg_adapted_childPkg_adaptedImpl#getAddElementActivity <em>Add Element Activity</em>}</li>
 *   <li>{@link de.mdelab.migmm.java2class_adapted.generated.impl.java2classChildPkg_adapted_childPkg_adaptedImpl#getMoveElementActivity <em>Move Element Activity</em>}</li>
 *   <li>{@link de.mdelab.migmm.java2class_adapted.generated.impl.java2classChildPkg_adapted_childPkg_adaptedImpl#getChangeAttributeActivity <em>Change Attribute Activity</em>}</li>
 *   <li>{@link de.mdelab.migmm.java2class_adapted.generated.impl.java2classChildPkg_adapted_childPkg_adaptedImpl#getTransformForwardActivity <em>Transform Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.migmm.java2class_adapted.generated.impl.java2classChildPkg_adapted_childPkg_adaptedImpl#getTransformMappingActivity <em>Transform Mapping Activity</em>}</li>
 *   <li>{@link de.mdelab.migmm.java2class_adapted.generated.impl.java2classChildPkg_adapted_childPkg_adaptedImpl#getTransformBackwardActivity <em>Transform Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.migmm.java2class_adapted.generated.impl.java2classChildPkg_adapted_childPkg_adaptedImpl#getConflictCheckForwardActivity <em>Conflict Check Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.migmm.java2class_adapted.generated.impl.java2classChildPkg_adapted_childPkg_adaptedImpl#getConflictCheckMappingActivity <em>Conflict Check Mapping Activity</em>}</li>
 *   <li>{@link de.mdelab.migmm.java2class_adapted.generated.impl.java2classChildPkg_adapted_childPkg_adaptedImpl#getConflictCheckBackwardActivity <em>Conflict Check Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.migmm.java2class_adapted.generated.impl.java2classChildPkg_adapted_childPkg_adaptedImpl#getSynchronizeForwardActivity <em>Synchronize Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.migmm.java2class_adapted.generated.impl.java2classChildPkg_adapted_childPkg_adaptedImpl#getSynchronizeBackwardActivity <em>Synchronize Backward Activity</em>}</li>
 *   <li>{@link de.mdelab.migmm.java2class_adapted.generated.impl.java2classChildPkg_adapted_childPkg_adaptedImpl#getRepairForwardActivity <em>Repair Forward Activity</em>}</li>
 *   <li>{@link de.mdelab.migmm.java2class_adapted.generated.impl.java2classChildPkg_adapted_childPkg_adaptedImpl#getRepairBackwardActivity <em>Repair Backward Activity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class java2classChildPkg_adapted_childPkg_adaptedImpl extends OperationalRuleImpl
		implements java2classChildPkg_adapted_childPkg_adapted {
	/**
	 ...
	 * @generated
	 */
	protected java2classChildPkg_adapted_childPkg_adaptedImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GeneratedPackage.Literals.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED;
	}
			...
			if (addElementActivity != oldAddElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__ADD_ELEMENT_ACTIVITY,
	...
	public Activity getMoveElementActivity() {
		if (moveElementActivity != null && moveElementActivity.eIsProxy()) {
			...
			if (moveElementActivity != oldMoveElementActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__MOVE_ELEMENT_ACTIVITY,
	...
	public Activity getChangeAttributeActivity() {
		if (changeAttributeActivity != null && changeAttributeActivity.eIsProxy()) {
			...
			if (changeAttributeActivity != oldChangeAttributeActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__CHANGE_ATTRIBUTE_ACTIVITY,
	...
	public Activity getTransformForwardActivity() {
		if (transformForwardActivity != null && transformForwardActivity.eIsProxy()) {
			...
			if (transformForwardActivity != oldTransformForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__TRANSFORM_FORWARD_ACTIVITY,
	...
	public Activity getTransformMappingActivity() {
		if (transformMappingActivity != null && transformMappingActivity.eIsProxy()) {
			...
			if (transformMappingActivity != oldTransformMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__TRANSFORM_MAPPING_ACTIVITY,
	...
	public Activity getTransformBackwardActivity() {
		if (transformBackwardActivity != null && transformBackwardActivity.eIsProxy()) {
			...
			if (transformBackwardActivity != oldTransformBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__TRANSFORM_BACKWARD_ACTIVITY,
	...
	public Activity getConflictCheckForwardActivity() {
		if (conflictCheckForwardActivity != null && conflictCheckForwardActivity.eIsProxy()) {
			...
			if (conflictCheckForwardActivity != oldConflictCheckForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__CONFLICT_CHECK_FORWARD_ACTIVITY,
	...
	public Activity getConflictCheckMappingActivity() {
		if (conflictCheckMappingActivity != null && conflictCheckMappingActivity.eIsProxy()) {
			...
			if (conflictCheckMappingActivity != oldConflictCheckMappingActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__CONFLICT_CHECK_MAPPING_ACTIVITY,
	...
	public Activity getConflictCheckBackwardActivity() {
		if (conflictCheckBackwardActivity != null && conflictCheckBackwardActivity.eIsProxy()) {
			...
			if (conflictCheckBackwardActivity != oldConflictCheckBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__CONFLICT_CHECK_BACKWARD_ACTIVITY,
	...
	public Activity getSynchronizeForwardActivity() {
		if (synchronizeForwardActivity != null && synchronizeForwardActivity.eIsProxy()) {
			...
			if (synchronizeForwardActivity != oldSynchronizeForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__SYNCHRONIZE_FORWARD_ACTIVITY,
	...
	public Activity getSynchronizeBackwardActivity() {
		if (synchronizeBackwardActivity != null && synchronizeBackwardActivity.eIsProxy()) {
			...
			if (synchronizeBackwardActivity != oldSynchronizeBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__SYNCHRONIZE_BACKWARD_ACTIVITY,
	...
	public Activity getRepairForwardActivity() {
		if (repairForwardActivity != null && repairForwardActivity.eIsProxy()) {
			...
			if (repairForwardActivity != oldRepairForwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__REPAIR_FORWARD_ACTIVITY,
	...
	public Activity getRepairBackwardActivity() {
		if (repairBackwardActivity != null && repairBackwardActivity.eIsProxy()) {
			...
			if (repairBackwardActivity != oldRepairBackwardActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__REPAIR_BACKWARD_ACTIVITY,
	...
	public TGGNode addElement(final EMap<String, Object> parameters) throws TransformationException {
		...
		return (TGGNode) parametersCopy.get("corrChildPkg_adapted");
	}
	...
	public boolean changeAttributeValues(final TGGNode correspondenceNode, final EMap<String, Object> ruleParameters)
		...
		params.put("corrChildPkg_adapted", correspondenceNode);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__ADD_ELEMENT_ACTIVITY:
			if (resolve)
				return getAddElementActivity();
			return basicGetAddElementActivity();
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__MOVE_ELEMENT_ACTIVITY:
			if (resolve)
				return getMoveElementActivity();
			return basicGetMoveElementActivity();
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__CHANGE_ATTRIBUTE_ACTIVITY:
			if (resolve)
				return getChangeAttributeActivity();
			return basicGetChangeAttributeActivity();
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__TRANSFORM_FORWARD_ACTIVITY:
			if (resolve)
				return getTransformForwardActivity();
			return basicGetTransformForwardActivity();
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__TRANSFORM_MAPPING_ACTIVITY:
			if (resolve)
				return getTransformMappingActivity();
			return basicGetTransformMappingActivity();
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__TRANSFORM_BACKWARD_ACTIVITY:
			if (resolve)
				return getTransformBackwardActivity();
			return basicGetTransformBackwardActivity();
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__CONFLICT_CHECK_FORWARD_ACTIVITY:
			if (resolve)
				return getConflictCheckForwardActivity();
			return basicGetConflictCheckForwardActivity();
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__CONFLICT_CHECK_MAPPING_ACTIVITY:
			if (resolve)
				return getConflictCheckMappingActivity();
			return basicGetConflictCheckMappingActivity();
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__CONFLICT_CHECK_BACKWARD_ACTIVITY:
			if (resolve)
				return getConflictCheckBackwardActivity();
			return basicGetConflictCheckBackwardActivity();
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__SYNCHRONIZE_FORWARD_ACTIVITY:
			if (resolve)
				return getSynchronizeForwardActivity();
			return basicGetSynchronizeForwardActivity();
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__SYNCHRONIZE_BACKWARD_ACTIVITY:
			if (resolve)
				return getSynchronizeBackwardActivity();
			return basicGetSynchronizeBackwardActivity();
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__REPAIR_FORWARD_ACTIVITY:
			if (resolve)
				return getRepairForwardActivity();
			return basicGetRepairForwardActivity();
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED__REPAIR_BACKWARD_ACTIVITY:
			if (resolve)
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED___ADD_ELEMENT__EMAP:
			return addElement((EMap<String, Object>) arguments.get(0));
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED___CHANGE_ATTRIBUTE_VALUES__TGGNODE_EMAP:
			return changeAttributeValues((TGGNode) arguments.get(0), (EMap<String, Object>) arguments.get(1));
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED___MOVE_ELEMENT__TGGNODE_TGGNODE_TGGNODE:
			return moveElement((TGGNode) arguments.get(0), (TGGNode) arguments.get(1), (TGGNode) arguments.get(2));
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED___TRANSFORM_FORWARD__TGGNODE_BOOLEAN_BOOLEAN:
			return transformForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1), (Boolean) arguments.get(2));
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED___TRANSFORM_MAPPING__TGGNODE_BOOLEAN_BOOLEAN:
			return transformMapping((TGGNode) arguments.get(0), (Boolean) arguments.get(1), (Boolean) arguments.get(2));
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED___TRANSFORM_BACKWARD__TGGNODE_BOOLEAN_BOOLEAN:
			return transformBackward((TGGNode) arguments.get(0), (Boolean) arguments.get(1),
					(Boolean) arguments.get(2));
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED___CONFLICT_CHECK_FORWARD__TGGNODE:
			return conflictCheckForward((TGGNode) arguments.get(0));
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED___CONFLICT_CHECK_MAPPING__TGGNODE:
			return conflictCheckMapping((TGGNode) arguments.get(0));
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED___CONFLICT_CHECK_BACKWARD__TGGNODE:
			return conflictCheckBackward((TGGNode) arguments.get(0));
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED___SYNCHRONIZE_FORWARD__TGGNODE_BOOLEAN:
			return synchronizeForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED___SYNCHRONIZE_BACKWARD__TGGNODE_BOOLEAN:
			return synchronizeBackward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED___REPAIR_FORWARD__TGGNODE_BOOLEAN:
			return repairForward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		case GeneratedPackage.JAVA2CLASS_CHILD_PKG_ADAPTED_CHILD_PKG_ADAPTED___REPAIR_BACKWARD__TGGNODE_BOOLEAN:
			return repairBackward((TGGNode) arguments.get(0), (Boolean) arguments.get(1));
		}
		return super.eInvoke(operationID, arguments);
	}

} //java2classChildPkg_adapted_childPkg_adaptedImpl
