...
public class TGGAdapter {
	...
	private NotifierVariablesScope<?, ?, ?, ?, ?, ?, EClassifier, ?, MLExpression> createDummyVariablesScope(TGGRule rule) {
		NotifierVariablesScope<?, ?, ?, ?, ?, ?, EClassifier, ?, MLExpression> dummyVariablesScope
